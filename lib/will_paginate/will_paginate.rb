...
require File.join(File.dirname(__FILE__), 'will_paginate', 'core_ext.rb')
...
module WillPaginate
  class << self
    ...
    def enable_activerecord
      ...
      require File.join(File.dirname(__FILE__), 'will_paginate', 'finder.rb')
  ...
  def self.registered(app)
    require File.join(File.dirname(__FILE__), 'will_paginate', 'view_helpers.rb')
    
    app.helpers ViewHelpers # padrino
  end
end
