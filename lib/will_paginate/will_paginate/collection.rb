module WillPaginate
  ...
  class Collection < Array
    ...
    attr_accessor :html_anchor, :default_desc
    
    attr_accessor :controller, :action # so that we can ask padrino to generate the link urls

    def setup_pagination(controller, action, default_desc = nil, html_anchor = nil)
